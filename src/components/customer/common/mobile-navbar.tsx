...
import {Heart, Icon, LogIn, LogOut, type LucideIcon, Menu, ShoppingBag, Store, User} from "lucide-react";
import { Separator } from "@/components/ui/separator";
import { Link } from "react-router-dom";

type CustomerDesktopNavbarProps = {
    isSignedIn: boolean;
}
...
// This function is used in the mobile navbar to render a section of the drawer with a title and a list of navigation items. 
// It takes in a title and an array of NavItem objects, and renders them as links in the drawer.
    ...
    return (
        ...
        <div className={drawerItemsWrap}>
            {items.map((item) => {
                ...
                return (
                <Link to={item.href} key={item.href} className={drawerItemLink}>
...
export function CustomerMobileNavbar({ isSignedIn }: CustomerDesktopNavbarProps) {
    ...
    return <div className={mobileWrap}>
