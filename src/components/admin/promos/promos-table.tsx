...
/**
 * Promo Table
 * @param promos - The list of promos
 * @param loading - Whether the table is loading
 * @param onDelete - The function to delete a promo
 * @param onEdit - The function to edit a promo
 * @param deletingPromoId - The id of the promo being deleted
 * @returns The promo table
 */
function PromoTable({
  promos,
  loading,
